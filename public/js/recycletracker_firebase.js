...
recycletracker.controller("recycletrackerctrl", function($scope, $firebaseObject) {
  ...
  // putting a console.log here won't work because the data ain't here yet, so don't
 
 var query = ref.orderByChild("datadate").limitToLast(7);
  
  // synchronize the object with a three-way data binding
  
  $scope.lastweek = $firebaseArray(query);
