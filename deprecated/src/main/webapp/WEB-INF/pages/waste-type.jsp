...
<div class="container">
    <form accept-charset="UTF-8" action="waste" class="form-horizontal"
        ...
        <div class="control-group integer required">
            <label class="integer required control-label" for="barcodeId"><abbr title="required">*</abbr>Barcode Id</label>
            <div class="controls">
                <input class="integer required span6" id="barcodeId" name="barcodeId" size="50" type="text">
            </div>
        </div>
        <div class="control-group boolean required">
            <label class="string required control-label" for="isRecyclable"><abbr title="required">*</abbr>Is Recyclable?</label>
            <div class="controls">
                <input class="boolean required span6" id="isRecyclable" name="isRecyclable" size="50" type="boolean">
            </div>
        </div>
        <div class="form-actions">
            <input class="btn btn-primary" name="commit" type="submit" value="Create Waste Type">
