...
${result}
<div class="container">
    <form accept-charset="UTF-8" action="unit" class="form-horizontal"
        ...
        <div class="control-group integer required">
            <label class="integer required control-label" for="floorNumber"><abbr title="required">*</abbr>Floor</label>
            <div class="controls">
        ...
        <div class="control-group integer required">
            ...
            <div class="controls">
                <input class="integer span6" id="suiteNumber" name="suiteNumber" size="50" type="integer">
            </div>
        </div>
        <div class="control-group string required">
            <label class="string required control-label" for="name"><abbr title="required">*</abbr>Unit Name</label>
            <div class="controls">
        ...
        <div class="control-group integer required">
            ...
            <div class="form-actions">
                <input class="btn btn-primary" name="commit" type="submit" value="Create Unit">
